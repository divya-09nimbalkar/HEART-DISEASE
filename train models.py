...
# Load your dataset
df = pd.read_csv(r'C:\Users\HP\Downloads\NIT_DATA_SCIENCE\spyder\Projects_of_Capstone_regression_model\11. CAPSTONE PROJECT_DEPLOYMENT\HEART DISEASE\heart_disease_uci.csv')
